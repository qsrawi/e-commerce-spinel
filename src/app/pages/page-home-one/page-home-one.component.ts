...
import { BlockProductColumnsItemComponent } from '../../modules/blocks/block-product-columns/block-product-columns-item/block-product-columns-item.component';
import { BlockProductColumnsComponent } from '../../modules/blocks/block-product-columns/block-product-columns.component';
import { BlockBrandsComponent } from '../../modules/blocks/block-brands/block-brands.component';
import { BlockPostsComponent } from '../../modules/blocks/block-posts/block-posts.component';
import { BlockCategoriesComponent } from '../../modules/blocks/block-categories/block-categories.component';
import { BlockProductsComponent } from '../../modules/blocks/block-products/block-products.component';
import { BlockBannerComponent } from '../../modules/blocks/block-banner/block-banner.component';
import { BlockProductsCarouselComponent } from '../../modules/blocks/block-products-carousel/block-products-carousel.component';
import { BlockFeaturesComponent } from '../../modules/blocks/block-features/block-features.component';
...
@Component({
    ...
    standalone: true,
    imports: [BlockSlideshowComponent, BlockFeaturesComponent, BlockProductsCarouselComponent, BlockBannerComponent, BlockProductsComponent, BlockCategoriesComponent, BlockPostsComponent, BlockBrandsComponent, BlockProductColumnsComponent, BlockProductColumnsItemComponent, AsyncPipe]
})
