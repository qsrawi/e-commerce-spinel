...
import { CarouselComponent, SlidesOutputData, CarouselModule } from 'ngx-owl-carousel-o';
...
@Component({
    ...
    standalone: true,
    imports: [RedZoomModule, NgIf, IconComponent, CarouselModule, OwlPreventClickDirective, NgFor, ClickDirective, FakeSlidesDirective]
})
