...
import { isPlatformBrowser, NgFor, NgIf, NgClass, NgTemplateOutlet } from '@angular/common';
...
@Component({
    ...
    standalone: true,
    imports: [NgFor, NgIf, NgClass, MegamenuComponent, MenuComponent, IconComponent, RouterLink, TouchClickDirective, NgTemplateOutlet]
})
