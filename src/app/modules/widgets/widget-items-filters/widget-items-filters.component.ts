...
@Component({
    ...
    standalone: true,
    imports: [CollapseDirective, NgClass, NgIf, FormsModule, ReactiveFormsModule, NgFor, CollapseItemDirective, IconComponent, CollapseContentDirective, RouterLink, NgxSliderModule, CurrencyFormatPipe]
})
