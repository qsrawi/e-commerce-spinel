...
import { isPlatformBrowser, NgClass, NgStyle, NgIf, AsyncPipe } from '@angular/common';
...
@Component({
    ...
    standalone: true,
    imports: [NgClass, IconComponent, RouterLink, SearchComponent, DropdownDirective, NgStyle, FormsModule, ReactiveFormsModule, NgIf, AsyncPipe]
})
